...
class LucasKanadeObj:
    def __init__(self, winsize=(15,15), maxLevel=2, 
                 maxCorners=70, qualityLevel=0.3, minDistance=7, blockSize=7):
        """
        Lucas Kanade object 
    ...
    def user_choose_corners(self, feature_grid_size):
        """
        ...
        grid = np.zeros((self.first_frame.shape[0]//feature_grid_size, self.first_frame.shape[1]//feature_grid_size))
        counter = 0
        for point in self.corners:
            ...
            if grid[int(point[0,1]//feature_grid_size), int(point[0,0]//feature_grid_size)] == 0:
                ...
                plt.annotate(counter, (point[0,0], point[0,1]), size=15, c='red')
